...
export interface ResumeAction {
 version:1;kind:ResumeKind;runId:string;workspaceId:string;actorId:string;baseVersion:number;inputDigest:string;
 authority:RunAuthority;limits:RunLimits;connection:ConnectionSummary;
}
export interface ApprovalView {
 id:string;kind:ResumeKind;runId:string;actionDigest:string;nonce:string;expiresAt:number;state:string;
 model:string;baseVersion:number;inputDigest:string;limits:RunLimits;connection:ConnectionSummary;
}
